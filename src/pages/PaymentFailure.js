  ...
  return (
    <div style={s.page}>
      <div style={s.card}>
        ...
        <p style={s.sub}>Something went wrong with your payment. Please try again.</p>
        <button style={s.btn} onClick={() => navigate(-1)}>Try Again</button>
...
const s = {
  ...
  btn: { width: '100%', padding: 14, borderRadius: 12, backgroundColor: C.ERROR, color: '#fff', border: 'none', fontSize: 15, fontWeight: 700, cursor: 'pointer', marginBottom: 10 },
